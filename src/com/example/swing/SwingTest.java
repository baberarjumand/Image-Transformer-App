/**
 * This program is an app with a GUI that can resize, rotate and save images.
 *
...
//				super.windowClosing(e);
				int shouldClose = JOptionPane.showConfirmDialog(frame, "Are you sure you want to close this window", "Confirm close", JOptionPane.YES_NO_OPTION);
